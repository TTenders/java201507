...
public class ManagerMainTest4 extends JDialog{
	...
	exitButton.addActionListener(new ActionListener() {
		...
		String tableColumns[]={"序号","姓名","基本工资","绩效工资","提成","补贴","个人税","备注","实得工资"};
		...
		tableValueV=UserDAO5.getAllUsers4();//获取所有用户信息
